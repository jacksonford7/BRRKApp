...
namespace BRBKApp.Views
{
    ...
    public partial class CediTarjaConsultaDetail : ContentPage, IQueryAttributable
    {
        ...
        public CediTarjaConsultaDetail(CediTarjaMensaje entry = null)
        {
            InitializeComponent();
            _entry = entry;
            BindingContext = new CediTarjaConsultaDetailViewModel(entry);
        }
        public CediTarjaConsultaDetail()
        {
            InitializeComponent();
            _entry = null;
            BindingContext = new CediTarjaConsultaDetailViewModel();
        }

        protected override void OnAppearing()
        {
            base.OnAppearing();
            var viewModel = BindingContext as CediTarjaConsultaDetailViewModel;
            if (viewModel != null)
            {
                ...
                System.Diagnostics.Debug.WriteLine($"ShowCodeInput en OnAppearing: {viewModel.ShowCodeInput}, ShowDetails: {viewModel.ShowDetails}");
            }
        }
        ...
        private async void OnImageTapped(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(parameter) || !int.TryParse(parameter, out int index))
            {
            ...
            switch (index)
            {
                case 0: imageSource = viewModel.ImageSource0; break;
                case 1: imageSource = viewModel.ImageSource1; break;
                case 2: imageSource = viewModel.ImageSource2; break;
                case 3: imageSource = viewModel.ImageSource3; break;
                case 4: imageSource = viewModel.ImageSource4; break;
                case 5: imageSource = viewModel.ImageSource5; break;
                case 6: imageSource = viewModel.ImageSource6; break;
                case 7: imageSource = viewModel.ImageSource7; break;
            }
        ...
        private void Entry_Focused(object sender, FocusEventArgs e)
        {
            ...
            {
                // Opcional: Mostrar un mensaje o vibración para indicar que está listo para escanear
                // Device.StartVibrate(100); // Descomentar si quieres vibración
            }
        }
        ...
        public void ApplyQueryAttributes(IDictionary<string, string> query)
        {
            ...
            {
                string origen = query["origen"]?.ToString();

                // Aquí pasas el origen al ViewModel
                if (BindingContext is CediTarjaConsultaDetailViewModel vm)
                {
                    vm.Origen = origen;
                }
            }
