...
namespace BRBKApp.Views
{
    ...
    public partial class VHSTarjaConsultaDetail : ContentPage, IQueryAttributable
    {
        ...
        public VHSTarjaConsultaDetail(VHSTarjaMensaje entry = null)
        {
            InitializeComponent();
            _entry = entry;
            BindingContext = new VHSTarjaConsultaDetailViewModel(entry);
        }
        public VHSTarjaConsultaDetail()
        {
            InitializeComponent();
            _entry = null;
            BindingContext = new VHSTarjaConsultaDetailViewModel();
        }

        protected override void OnAppearing()
        {
            base.OnAppearing();
            var viewModel = BindingContext as VHSTarjaConsultaDetailViewModel;
            if (viewModel != null)
            {
        ...
        public void ApplyQueryAttributes(IDictionary<string, string> query)
        {
            if (query.ContainsKey("origen"))
            {
                ...
                if (BindingContext is VHSTarjaConsultaDetailViewModel vm)
                {
                    vm.Origen = origen;
                }
            }
